...
void Produto::setValorU(double valor){ // Método para setar a quantidade de um objeto do tipo produto
     this->valor = valor;
}
...
double Produto::getValorU(){ // Método que retorna a quantidade do Produto
    return valor;
}
